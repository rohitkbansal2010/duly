...
using Duly.Clinic.Fhir.Adapter.Configuration;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                ...
                {
                    config.Filters.Add(typeof(IdentityObfuscationFilter));
                })
            ...
            services.AddObfuscators(Configuration);
            services.AddObfuscationFilters();

            services.AddApiModules(Configuration);

            services.AddFhir(Configuration);

            services.AddPrivateApi(Configuration);
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IMapper mapper)
        {
            ...
            app.UseClinicSystemSwagger();

            mapper.ConfigurationProvider.AssertConfigurationIsValid();

            app.UseJsonExceptionHandling(Configurations.ModuleInitializer.ExtendErrorHandlingOptions);
