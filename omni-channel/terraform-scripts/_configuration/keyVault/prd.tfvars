keyvaults = [
  {
    name                            = "duly-p-oc-apmg-orc-kv"
    rg_name                         = "duly-p-appointment-management-rg"
    sku                             = "standard"
    ...
    secrets = {
      ...
      "IngestionSettings--IngestionApiUrl"    = "https://api.duly.digital/communication/ingestion/v1/request"
