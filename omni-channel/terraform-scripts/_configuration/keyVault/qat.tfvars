keyvaults = [
  {
    name                            = "duly-q-oc-apmg-orc-kv"
    rg_name                         = "duly-q-appointment-management-rg"
    sku                             = "standard"
    ...
    secrets = {
      ...
      "IngestionSettings--IngestionApiUrl"    = "https://api-qat.duly-np.digital/communication/qat/ingestion/v1/request"
