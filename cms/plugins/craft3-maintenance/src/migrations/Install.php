...
namespace punchkick\maintenance\migrations;
...
/**
 * craft3-maintenance Install Migration
 *
...
class Install extends Migration
{
    ...
    // maintenance_maintenancerecord table
        $tableSchema = Craft::$app->db->schema->getTableSchema('maintenance_plugin');
        if ($tableSchema === null) {
            $tablesCreated = true;
            $this->createTable(
                'maintenance_plugin',
    ...
    {
    // maintenance_maintenancerecord table
        $this->dropTableIfExists('maintenance_plugin');
    }
}
