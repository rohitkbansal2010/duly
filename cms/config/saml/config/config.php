...
$config = [
     ...
     * reverse proxy).
     */
    'baseurlpath' => getenv('DEFAULT_SITE_URL') . '/saml/',
     ...
     * root directory.
     */
    'certdir' => APP_ROOT . '/config/saml/certs/',
    'loggingdir' => APP_ROOT . '/storage/logs/',
    'datadir' => APP_ROOT . '/storage/runtime/saml/ata',
    'tempdir' => APP_ROOT . '/storage/runtime/saml/temp',
     ...
     */
    'technicalcontact_name' => getenv('SAML_TECHNICAL_CONTACT_NAME'),
    'technicalcontact_email' => getenv('SAML_TECHNICAL_CONTACT_EMAIL'),
     ...
     */
    'secretsalt' => getenv('SAML_IDP_SECRETSALT'),
     ...
     */
    'auth.adminpassword' => getenv('SAML_IDP_ADMIN_PASSWORD'),

    /*
     * Set this options to true if you want to require administrator password to access the web interface
     * or the metadata pages, respectively.
     */
    'admin.protectindexpage' => getenv('ENVIRONMENT') == 'lxc',
     ...
     */
    'showerrors' => getenv('ENVIRONMENT') != 'lxc',
     ...
     *
     */
    'logging.level' => getenv('ENVIRONMENT') == 'lxc' ? 5 : 7,
     ...
     */
    'session.datastore.timeout' => (20 * 60),

    /*
     * Sets the duration, in seconds, auth state should be stored.
     */
    'session.state.timeout' => (20 * 60),

    /*
     * Option to override the default settings for the session cookie name
     */
    'session.cookie.name' => 'DMGSAML',
     ...
     */
    'session.phpsession.cookiename' => 'DMGSAML',
     ...
     */
    'session.authtoken.cookiename' => 'DMGSAMLAuthToken',
     ...
     */
    'theme.use' => 'epic:dupage',
    'usenewui' => true,
    'theme.controller' => \SimpleSAML\Module\epic\DupageController::class,
     ...
     * set it to false.
     */
    'template.auto_reload' => getenv('ENVIRONMENT') != 'lxd',
     ...
     * Defaults to true.
     */
    'production' => getenv('ENVIRONMENT') == 'lxd',
