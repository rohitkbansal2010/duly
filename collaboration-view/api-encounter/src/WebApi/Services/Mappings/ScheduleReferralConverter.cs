// <copyright file="ScheduleReferralConverter.cs" company="Duly Health and Care">
...
{
    public class ScheduleReferralConverter : ITypeConverter<Contracts.ScheduleReferral, Models.ScheduleReferral>
    {
        public Models.ScheduleReferral Convert(Contracts.ScheduleReferral source, Models.ScheduleReferral destination, ResolutionContext context)
        {
            return new Models.ScheduleReferral
            {
                ID = source.ID,
                ...
                VisitType_Id = source.VisitTypeId
            };
        }
    }
}
