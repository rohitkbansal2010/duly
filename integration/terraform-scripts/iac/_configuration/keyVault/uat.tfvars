keyvaults = [
  {
    ...
    secrets = {
      ...
      "Audit--ServiceBusQueue"                       = "u-integration-clinic-audit-sbq"
      ...
      "ServiceBusOptions--QueueName"                 = "u-integration-clinic-audit-sbq"
    }
