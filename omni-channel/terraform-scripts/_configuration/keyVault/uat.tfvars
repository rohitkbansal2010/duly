keyvaults = [
  {
    name                            = "duly-u-oc-apmg-orc-kv"
    rg_name                         = "duly-u-appointment-management-rg"
    sku                             = "standard"
    ...
    secrets = {
      ...
      "IngestionSettings--IngestionApiUrl"    = "https://api-uat.duly-np.digital/communication/ingestion/v1/request"
