keyvaults = [
  {
    name                            = "duly-d-oc-apmg-orc-kv"
    rg_name                         = "duly-d-appointment-management-rg"
    sku                             = "standard"
    ...
    secrets = {
      ...
      "IngestionSettings--SubscriptionKey"    = "acb28e78b29e4cc082cd9a128c90e3ed"
      "IngestionSettings--IngestionApiUrl"    = "https://api-dev.duly-np.digital/communication/ingestion/v1/request"
