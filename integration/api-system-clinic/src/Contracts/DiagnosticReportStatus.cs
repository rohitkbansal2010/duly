// <copyright file="DiagnosticReportStatus.cs" company="Duly Health and Care">
...
{
    [Description("Statusses of diagnostic report")]
    ...
    public enum DiagnosticReportStatus
    {
        ...
        Cancelled,
        [Description("The report has been withdrawn following a previous final release.")]
        EnteredInError,
